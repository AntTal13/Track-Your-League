...
# Can I view the website if I am not a user/signed in?

At this time, no. You may only interact with the website if you have an account with Track Your League.
...
# Upcoming Features
* See Averaged Stats for **EACH** player on roster page
* Total stats in box scores
* Implement greater user centric capabilities
* Implement a view page for box scores, rosters and team standings for those not logged in and/or those who will not be adding a team/stats
